...
namespace TDFramework
{
    ...
    public class UIMainPanel_Mediator : Mediator
    {
        #region 字段
        private static string Name = "UIMainPanel_Mediator";
        #endregion	

        #region 构造函数
        public UIMainPanel_Mediator() : this(null, null)
        {
            
        }
        public UIMainPanel_Mediator(string mediatorName, object viewComponent = null) : base(mediatorName, viewComponent)
        {
